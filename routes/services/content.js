                ...
                motds: [
                    {
                        ...
                        title: "Cloud",
                        body: "Welcome to Cloud, a private server created by Mjay (@dc#0640), GD (@GD_Gaming#2021) and Ken (Sky#0001).",
                        videoLoop: false,
                ...
                messages: [
                    {
                        ...
                        subgame: "br",
                        title: "Cloud",
                        body: "Credits: Ken(Backend Help), GD(dev parties/hosting) Mjay(design ui, backend and html)  ",
                        spotlight: true
                    }
                ]
            },
